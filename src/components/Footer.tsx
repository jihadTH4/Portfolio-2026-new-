...
export function Footer() {
  ...
  return (
    <footer className="w-full py-12 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-8 bg-surface-container-lowest/50 border-t border-white/5 relative overflow-hidden">
      <div
        className={`font-display text-9xl font-black text-on-surface opacity-[0.03] absolute bottom-0 pointer-events-none select-none ${lang === "ar" ? "-right-10" : "-left-10"}`}>
        {lang === "ar" ? "جهاد" : "JIHAD"}
      </div>
        ...
        {[
          {
            ...
            href: "https://www.instagram.com/thabitjihad?igsh=MXdnYnpjYXNpbXZ1MA==",
          },
          {
            name: t.footer.socials.whatsapp,
            href: "https://wa.me/970595665806",
          },
          {
            name: t.footer.socials.github,
            href: "https://github.com/jihadTH4",
          },
        ].map((item) => (
          <a
            key={item.name}
